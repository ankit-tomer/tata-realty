              	...
              	<div class="col-10 offset-1">
              		<form action="" class="row regist_form">
              			...
              			<div class="form-group col-12">
                            ...
                            <input type="radio" id="radioApple" name="gender" value="apFemaleple" checked>
              				...
              				<div class="row">
              					<div class="col-6 padd_r0 text-left">
              						<button class="verify_btn">
		              					Verify &nbsp;<i class="fa fa-caret-right"></i>
		              				</button>
	              				</div>
								...
								<p>&nbsp;</p>
	              				<div class="col-12 text-center">
	              					<a href="#" class="already_rigy">Already registered member click here</a>
	              				</div>
								<p>&nbsp;</p>
								<p>&nbsp;</p>
	              				<div class="col-12 text-center">
