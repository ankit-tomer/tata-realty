         ...
         <div class="container">
            ...
            <div class="main row">
            	<div class="family_patch regi_fami_patch col-10 offset-1">
                 ...
                 <p class="yu_regi_txt" style="opacity: 0">You registered Successfully!</p> 
              		<form action="" class="row regist_form">
              			<div class="form-group col-12">
              				<div class="name_prefilled form-control">Samit</div>
              				<span class="remark reg_admin">Admin</span>
              			</div>
              			<div class="form-group col-12">
              				<div class="name_prefilled form-control">Samit</div>
              				<span class="remark rem_success">Verified</span>
              			</div>
              			<div class="col-6 offset-3 text-center">
              				<button class="verify_btn">
				               Play Now <i class="fa fa-caret-right"></i> 
				            </button>
				            <p>&nbsp;</p>
              			</div>
              			...
              			<div class="form-group col-12">
              				<div class="name_prefilled form-control">Samit</div>
              				<button class="remind_admin">Remind <i class="fa fa-caret-right"></i></button>
              				<span class="remark rem_pending">Pending</span>
              			</div>
                    <div class="col-12 theme_blue text-center">
                        <p class="invi_txt">Invite more member to your group</p>
                    </div>
              			<div class="form-group col-12">
              			...
              			<div class="form-group col-12">
              				<div class="row">
              					<div class="col-6 padd_r0 text-left">
              						<button class="verify_btn">
		              					 Invite <i class="fa fa-caret-right"></i>
		              				</button>
	              				</div>
