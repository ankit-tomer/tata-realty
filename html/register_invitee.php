         ...
         <div class="container">
            ...
            <div class="main row">
            	<div class="col-10 offset-1 text-center">
            		<h3 class="theme_blue">Welcome <span>Richa</span>!</h3>
              		<p>Your friend Samit inveted you to his group <br/>
						to play Phone chodo dil jodo game!</p>	
            	</div>
              	...
              	<div class="col-10 offset-1">
                      ...
                      <div class="row">
                        <div class="radio-toolbar">
                            <input type="radio" id="radioApple" name="gender" value="Female" checked>
                            <label for="radioApple">Female</label>

                            <input type="radio" id="radioBanana" name="gender" value="Male">
                            <label for="radioBanana">Male</label>
                        </div>
                      </div>
                    </div>
              			<div class="form-group col-12">
              			...
              			<div class="form-group col-12">
              				<div class="row">
              					<div class="col-5 padd_r0 text-left">
              						<button class="verify_btn">
		              					Confirm <span><i class="fa fa-caret-right"></i></span>
		              				</button>
	              				</div>
