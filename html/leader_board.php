           ...
           <div class="in_out_time col-10 offset-1">
            ...
            <div class="main row blue_texture">
              <div class="container leader_board_cov">
                <h3 class="text-center title">LEADERBOARD</h3>
                <div class="leader_scroll">
                  <div class="col-10 offset-1">
                    <div class="leader_blk color1">
                      <div class="img_cov">
                        <img src="img/female_profile.jpg" class="img-fluid" alt="">
                      </div>
                      <div class="txt_cov">
                        <span>Sharma Family</span> <br/>
                        <span>48:43:51</span>
                      </div>
                      <div class="rank">
                        <span class="pull-right">01 <sup>st</sup></span>
                      </div>
                    </div>
                    <div class="leader_blk color1">
                      <div class="img_cov">
